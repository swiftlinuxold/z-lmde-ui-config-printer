...
class Wizard:
    ...
    def __init__(self):
        ...
        self.window.set_title("Printer Wizard") # Set the window title
        ...
        # OPTION 1: sys-config-printer
        self.box_image = '/usr/share/icons/gTangish-2.0a1/32x32/actions/stock_print-setup.png'
        self.box_label = 'system-config-printer'
        self.box = self.wizard_option (self.box_image, self.box_label, self.sys_config_printer)
        self.vbox.add (self.box)
        
        # Option 2: CUPS
        self.box_image = '/usr/share/icons/gTangish-2.0a1/32x32/actions/stock_print-setup.png'
        self.box_label = 'CUPS Web Interface'
        self.box = self.wizard_option (self.box_image, self.box_label, self.cups)
        self.vbox.add (self.box)
    ...
    def sys_config_printer (self, widget, callback_data=None):
        os.system ('system-config-printer &')
        
    def cups (self, widget, callback_data=None):
        os.system ('iceweasel localhost:631 &')
